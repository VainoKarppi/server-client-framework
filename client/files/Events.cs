...
public class NetworkEvents {
    ...
    protected virtual void OnClientConnected(OnClientConnectEvent classData) => ClientConnected?.Invoke(this, classData);
    ...
    protected virtual void OnServerShutdown(OnServerShutdownEvent classData) => ServerShutdown?.Invoke(this, classData);



    /// <summary> Uses async.</summary>
    public event EventHandler<OnMessageSentEvent>? MessageSent;
    protected virtual void OnMessageSent(OnMessageSentEvent classData) => MessageSent?.Invoke(this, classData);

    /// <summary> Uses async.</summary>
    public event EventHandler<OnMessageReceivedEvent>? MessageReceived;
    protected virtual void OnMessageReceived(OnMessageReceivedEvent classData) => MessageReceived?.Invoke(this, classData);



    /// <summary> Uses blocking.</summary>
    public event EventHandler<OnHandShakeStartEvent>? HandshakeStart;
    protected virtual void OnHandShakeStart(OnHandShakeStartEvent classData) => HandshakeStart?.Invoke(this, classData);

    /// <summary> Uses blocking.</summary>
    public event EventHandler<OnHandShakeEndEvent>? HandshakeEnd;
    protected virtual void OnHandShakeEnd(OnHandShakeEndEvent classData) => HandshakeEnd?.Invoke(this, classData);
}
