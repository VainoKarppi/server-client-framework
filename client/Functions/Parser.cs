...
/*
    ...
    var test = DataArray.Unserialize(code);
    ...
    string toArma = DataArray.Serialize(arr);
    Console.WriteLine(toArma);
...
public class DataArray : List<object> {
    ...
    // From ARMA TO CS
    public static DataArray UnserializeArray(string[] args) {
    ...
    public static DataArray Unserialize(string args) {
        if (args.ElementAt(0) != '[') 
            args = "[" + args + "]";
    ...
    // FROM ARMA to CS
    public static string Serialize(DataArray array) {
    ...
    public DataArray AsArray(int index) {
        return (this[index] as DataArray);
    }
